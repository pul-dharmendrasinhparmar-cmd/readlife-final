...
export default function TrolleyDetailPage() {
  ...
  const game = MINI_GAMES.find((g) => g.id === "trolley") as MiniGame;
    ...
    <div className="page-shell min-h-screen pb-16">
      ...
      <main className="mx-auto max-w-3xl px-4 pt-8 sm:px-6">
        ...
        <p className="mt-3 max-w-xl text-muted">
          Steer a library trolley, catch falling books and reading goodies, and
          dodge coffee spills. Unique covers open story worlds — and your catch
          mix reveals a reader type.
        </p>
        <button
          type="button"
          ...
          <section className="mt-10 rounded-[1.5rem] border border-[#4a425c] bg-[#3a324f]/90 p-6">
            ...
            <ul className="mt-4 grid gap-3 text-sm text-muted sm:grid-cols-2">
              ...
              <li>
                ...
                <p className="font-semibold text-ink">
                  {t.lastScore?.toLocaleString() ?? "—"}
                </p>
              </li>
              <li>
                <span className="text-muted-soft">Play streak</span>
                <p className="font-semibold text-ink">
                  {t.currentPlayStreak} days
                </p>
              </li>
              <li>
                <span className="text-muted-soft">Books caught last run</span>
                <p className="font-semibold text-ink">
                  {t.lastCollected ?? "—"}
                </p>
              </li>
              <li>
                ...
                <p className="font-semibold text-ink">{t.gamesPlayed}</p>
              </li>
              <li>
                <span className="text-muted-soft">Last reader type</span>
                <p className="font-semibold text-ink">
                  {t.lastReaderType ?? "—"}
                </p>
              </li>
