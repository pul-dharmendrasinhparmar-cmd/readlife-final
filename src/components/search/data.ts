...
export const DISCOVER_READERS: DiscoverReader[] = [
  ...
  },
  {
    ...
    username: "bookiepp",
    avatar: "/avatars/5.png",
    readingPersonality: "The Soft Explorer",
    favoriteGenres: ["Fantasy", "Romance", "Contemporary"],
    currentBook: "Legends & Lattes",
    readingMatch: 81,
    matchReasons: ["comfort fantasy", "TBR energy"],
    followers: 640,
    following: 510,
    section: "similar",
  },
  {
    ...
    avatar: "/avatars/6.png",
    readingPersonality: "The Steady Chapter",
    favoriteGenres: ["Literary", "Fantasy", "Memoir"],
    currentBook: "Babel",
    readingMatch: 74,
    matchReasons: ["thoughtful pacing", "annotated reads"],
    followers: 1180,
    following: 290,
    section: "similar",
  },
  {
    ...
    username: "theostacks",
    avatar: "/avatars/2.png",
    readingPersonality: "The Shelf Architect",
    favoriteGenres: ["Sci-Fi", "Fantasy", "Nonfiction"],
    currentBook: "Project Hail Mary",
    readingMatch: 69,
    matchReasons: ["smart plots", "page-turners"],
    followers: 920,
    following: 175,
    section: "broaden",
  },
  {
    id: "sage",
    displayName: "Sage",
    username: "sageandspines",
    avatar: "/avatars/4.png",
    readingPersonality: "The Quiet Collector",
    favoriteGenres: ["Poetry", "Literary", "Magical Realism"],
    currentBook: "The Night Circus",
    readingMatch: 83,
    matchReasons: ["atmospheric prose", "dreamlike shelves"],
    followers: 2040,
    following: 133,
    section: "list-makers",
  },
