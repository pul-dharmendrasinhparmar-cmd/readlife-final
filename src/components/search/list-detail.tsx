  ...
  return (
    <div className="fixed inset-0 z-[60]">
      ...
      <div
        ...
        className="absolute inset-y-0 right-0 flex w-full max-w-lg flex-col overflow-hidden border-l border-[#4a425c] bg-[#3a324f] shadow-[-16px_0_48px_rgba(42,36,56,0.18)]"
      >
        <div className="border-b border-[#564d6a] px-5 py-4">
            ...
            <div>
              ...
              {creator ? (
                <Link
                  ...
                  className="mt-1 inline-flex items-center gap-2 text-sm text-muted hover:text-ink"
                >
          ...
          <div className="mt-4 rounded-2xl bg-[#2a2438]/90 px-3.5 py-3">
          ...
          <ul className="space-y-3">
            {list.bookIds.map((id) => {
              ...
              return (
                <li
                  key={id}
                  className="flex items-center gap-3 rounded-2xl border border-[#564d6a] bg-[#342c45]/70 p-2.5"
                >
                  {selectMode ? (
                    <input
                      type="checkbox"
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[0.65rem] font-semibold text-ink/70">
                        {status}
